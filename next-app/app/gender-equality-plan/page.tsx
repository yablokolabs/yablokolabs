      ...
      <section className="hero">
        <div className="hero-content">
          ...
          <p className="hero-subtitle">
            At Yabloko Labs, we are committed to fostering an inclusive workplace where all individuals, 
            regardless of gender, have equal opportunities to thrive, innovate, and contribute to our quantum computing revolution.
          </p>
          <div className="cta-buttons">
            ...
            <a href="/assets/documents/gender-equality-plan-printable.html" className="btn btn-outline" target="_blank" rel="noopener noreferrer">
          ...
          <div className="about-content">
            <div className="about-text">
              ...
              <div className="about-description">
                ...
                <p>
                  This Gender Equality Plan outlines our comprehensive approach to creating and maintaining an inclusive workplace 
                  where all team members can reach their full potential. We are committed to transparency, accountability, and 
                  continuous improvement in our pursuit of gender equality across all aspects of our organization.
                </p>
                
                <p>
                  As a technology company operating in the quantum computing space, we recognize that our industry has historically 
                  faced challenges with gender representation. We are determined to be part of the solution by implementing 
                  evidence-based strategies that promote equality and create lasting positive change.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="container">
          ...
          <div className="brands-grid">
            ...
            <div className="brand-card">
              ...
              <p className="brand-description">
                Clear pathways for career advancement, mentorship programs, and targets for gender representation 
                in leadership positions ensure equal opportunities for professional growth.
              </p>
            </div>
          </div>
        </div>
      ...
      <section id="implementation" className="partnership-section">
        <div className="container">
          <div className="section-header">
            ...
            <p className="section-subtitle">
              Our structured approach to implementing gender equality initiatives with clear timelines and responsibilities
            </p>
          </div>
          
          <div className="implementation-timeline">
            <div className="timeline-section">
              <h3 style={{ color: '#6366f1', fontSize: '1.5rem', marginBottom: '1.5rem' }}>Short-term Actions (0-6 months)</h3>
              <div className="timeline-grid">
                <div className="timeline-item">
                  ...
                  <div className="timeline-content">
                    ...
                    <p>Comprehensive review of all HR policies to ensure gender-neutral language and inclusive practices.</p>
                ...
                <div className="timeline-item">
                  ...
                  <div className="timeline-content">
                    ...
                    <p>Establish comprehensive data collection systems for gender representation across all departments and levels.</p>
            ...
            <div className="timeline-section">
              <h3 style={{ color: '#06b6d4', fontSize: '1.5rem', marginBottom: '1.5rem' }}>Medium-term Actions (6-12 months)</h3>
              <div className="timeline-grid">
                <div className="timeline-item">
                  <div className="timeline-icon">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                  ...
                  <div className="timeline-content">
                    ...
                    <p>Implement structured mentorship and sponsorship programs to support career advancement for all genders.</p>
                ...
                <div className="timeline-item">
                  ...
                  <div className="timeline-content">
                    ...
                    <p>Expand flexible working options and implement family-friendly policies including enhanced parental leave.</p>
      ...
      <section id="review" className="social-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2 className="section-title" style={{ color: '#23264d', background: 'none', WebkitBackgroundClip: 'unset', WebkitTextFillColor: 'unset', textShadow: 'none' }}>Review & Updates</h2>
            <p className="section-subtitle">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '2rem', marginTop: '3rem' }}>
            ...
            <div style={{ 
              ...
              <ul style={{ color: '#000000 !important', lineHeight: '1.6' }}>
                ...
                <li style={{ color: '#000000 !important' }}>Transparent communication of changes to all stakeholders</li>
              </ul>
            </div>
          ...
          <div style={{ marginTop: '3rem', textAlign: 'center' }}>
            <div style={{ 
              ...
              <p style={{ color: '#000000', fontSize: '1.125rem', margin: 0 }}>
                This Gender Equality Plan will be comprehensively reviewed and updated by <strong>December 2025</strong>, 
                with interim assessments conducted quarterly to ensure we remain on track with our commitments.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container">
          <div className="about-content">
            <div className="about-text">
              ...
              <div className="about-description">
                <p>
                  We welcome questions, suggestions, and feedback about our Gender Equality Plan. 
                  Your input is valuable in helping us create a more inclusive and equitable workplace for everyone.
                </p>
                ...
                <div style={{ 
                  ...
                  <a href="mailto:ceo@yablokolabs.com?subject=Gender%20Equality%20Plan%20Inquiry" className="btn btn-primary">
                    Contact Leadership
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
